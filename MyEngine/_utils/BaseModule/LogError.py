...
TypesLevels = {
    'CRITICAL': {"weight": 40, "function": lambda: exit(0)},
...
class Core:
    ...
    def __repr__(self) -> str:
        return f"<BaseModule.LogError.Core hash={hash(self)} name={self._coreName} \n - {self.options=}>"
...
class LogError(metaclass=Singleton):
    def __init__(self):
    ...
    def __repr__(self) -> str:
        return "<BaseModule.LogError handlers=%r, calls=%i, hash=%s, hash_core=%s, core_name=%s>" % (
