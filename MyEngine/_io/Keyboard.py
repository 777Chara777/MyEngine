...
class Keyboard:
    ...
    def on_press(self, key: str, function, *args, **kwargs):
        keys = pykey.get_pressed()
        key = key.lower()

        data_simbls = { 8:   "backspace",              
            9:   "tab",         
            13:  "return",                  
            27:  "escape",            
            32:  "space",             
        ...
        if key not in data_simbls_encode:
            ...
            logerror.crit(f"Dont find key '{key}' do you meen {' or '.join(meen_keys)}?")

        # print(keys[data_simbls_encode[key]], data_simbls_encode[key], key)
